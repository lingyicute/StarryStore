...
import com.looker.starrystore.utility.common.extension.firstOrNull
...
import com.looker.starrystore.utility.serialization.productItem
...
object Database {
    ...
    private class Helper(context: Context) : SQLiteOpenHelper(context, "starrystore", null, 5) {
        var created = false
            private set
        var updated = false
            private set
